...
```bash
# 构建镜像
docker build -t inventory/registry-service:3.0.0 .

# 运行容器
docker run -p 8761:8761 inventory/registry-service:3.0.0
```

## API文档

服务启动后访问: http://localhost:8761/swagger-ui.html
...
主要配置文件位于 `config-repo/registry-service/`
